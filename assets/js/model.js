export const state = {
  services: [
    {
      image: "assets/img/icons/sr-7-1.svg",
      title: "Makeup Mastery",
      description:
        "Elevate your skills with expert-led virtual and hands-on lessons.",
    },
    {
      image: "assets/img/icons/hair-salon-icon.svg",
      title: "Hair Hub",
      description:
        "Wig-making and human hair installs for versatile styling expertise.",
    },
    {
      image: "assets/img/icons/sr-7-3.svg",
      title: "Nail Tech Pro",
      description:
        "Nail the art of nail techniques with our comprehensive courses.",
    },
    {
      image: "assets/img/icons/increase-graph-profit-icon.svg",
      title: "Biz Boost",
      description:
        "Compulsory business and entrepreneurship for social upliftment and success.",
    },
    {
      image: "assets/img/icons/yoga-exercise-icon.svg",
      title: "Mindset Magic",
      description:
        "Transformative 'I Can' program integrating mental wellness and personal development.",
    },
    {
      image: "assets/img/icons/certificate-medal-quality-icon.svg",
      title: "Certification",
      description:
        "Get certified via weighted assessments and exclusive apprenticeships.",
    },
  ],
  courses: [
    {
      title: "Professional Makeup Artistry Mastery",
